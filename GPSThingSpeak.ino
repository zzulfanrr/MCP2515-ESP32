...
// const char* channel_key = "MV6QRA87EVBW3R5S";
// unsigned long channel_number = 3;
...
//     static int count = 1;
//     String csvlog = String(count++) + "," + String(engine_load) + "," + String(ect) + "," + String(stft) + "," + String(manifold_air_pressure) + "," + String(engine_rpm) + "," + String(vehicle_speed) + "," + String(iat) + "," + String(throttle_position) + "," + String(latitude, 6) + "," + String(longitude, 6);
...
// void logPID() {
//   ThingSpeak.setField(1, engine_load);
//   ThingSpeak.setField(2, ect);
//   ThingSpeak.setField(3, stft);
//   ThingSpeak.setField(4, manifold_air_pressure);
//   ThingSpeak.setField(5, engine_rpm);
//   ThingSpeak.setField(6, vehicle_speed);
//   ThingSpeak.setField(7, iat);
//   ThingSpeak.setField(8, throttle_position);
